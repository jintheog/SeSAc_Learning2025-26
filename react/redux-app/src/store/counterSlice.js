...
// 액션 내보내기
export const { increment, incremenetByAmount, reset } = counterSlice.actions;
//원래는 export const increment = counterslice.actions.increment
//원래는 export const incrementByAmount = counterslice.actions.incrementByAmount
//원래는 export const reset = counterslice.actions.reset
